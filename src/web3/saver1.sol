...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    // Recover Saver
    ERC20 _saverContract = ERC20(0xB4B171e9491bc272C46e648b74340d41aa4e1C68);
    ...
    uint256 public timeStableCoinReward = 12 hours;
    ...
    constructor(string memory name_, string memory symbol_) 
    {
        ...
        totalDonations = _saverContract.totalDonations();
        totalStableCoinDistribute = _saverContract.totalStableCoinDistribute();
    }
...
contract SaverCommunity is ERC20 {
    constructor() ERC20("Saver Community", "SAVER1") {
